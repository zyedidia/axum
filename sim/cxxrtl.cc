...
#include "axum_top.cxx"

void reset(cxxrtl_design::p_axum__top& soc) {
...
void dump_regs(cxxrtl_design::p_axum__top& soc) {
    // for (int i = 0; i < 32; i++) {
    //     printf("x%d: %d\n", i, soc.memory_p_cpu__unit_2e_decode__unit_2e_reg__file__unit_2e_regs[i].get<unsigned>());
    // }
}

void dump_mem(cxxrtl_design::p_axum__top& soc, unsigned max_addr) {
